...
public class NinthComputerChapters extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ninth_computer_chapters);
    ...
    public void onClick(View position)
    {
        if (position == mOne) {
            ...
            Intent intent = new Intent(NinthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthComputerChapter1");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthComputerChapter2");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthComputerChapter3");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthComputerChapter4");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthComputerChapter5");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthComputerChapter6");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthComputerChapter7");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthComputerChapter8");
            startActivity(intent);
        }
    }
}
