package com.assorttech.myquizler.NinthQuizType.NinthBioQuizType.NinthBioChapterWise;
...
public class NinthBioChapters extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ninth_bio_chapters);
    ...
    public void onClick(View position)
    {
        if (position == mOne) {
            ...
            Intent intent = new Intent(NinthBioChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioChapter1");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthBioChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioChapter2");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthBioChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioChapter3");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthBioChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioChapter4");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthBioChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioChapter5");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthBioChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioChapter6");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthBioChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioChapter7");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthBioChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioChapter8");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthBioChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioChapter9");
            startActivity(intent);
        }
    }
}
