...
public class SecondYearComputerChapters extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_year_computer_chapters);
    ...
    public void onClick(View position)
    {
        if (position == mOne) {
            ...
            Intent intent = new Intent(SecondYearComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerChapter1");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerChapter2");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerChapter3");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerChapter4");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerChapter5");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerChapter6");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerChapter7");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerChapter8");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerChapter9");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerChapter10");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerChapter11");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerChapter12");
            startActivity(intent);
        }
