...
import com.assorttech.myquizler.SecondYearComplete.SecondYearChapters.SecondYearComputerChapters;

public class SecondYearComputer extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_year_computer);
    ...
    public void onClick(View position)
    {
        if (position == mChapterWise) {
            ...
            startActivity(new Intent(SecondYearComputer.this, SecondYearComputerChapters.class));

        } else if (position == mPastPaper) {
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputer.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerPastPaper");
            startActivity(intent);

        } else if (position == mFirstHalf) {
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputer.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerFirstHalf");
            startActivity(intent);

        } else if (position == mSecondHalf) {
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputer.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerSecondHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearComputer.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearComputerBioFullBook");
            startActivity(intent);
        }
    }
}
