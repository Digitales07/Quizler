...
public class SecondYearPhysicsChapters extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_year_physics_chapters);
    ...
    public void onClick(View position)
    {
        if (position == mOne) {
            ...
            Intent intent = new Intent(SecondYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearPhysicsChapter1");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearPhysicsChapter2");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearPhysicsChapter3");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearPhysicsChapter4");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearPhysicsChapter5");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearPhysicsChapter6");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearPhysicsChapter7");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearPhysicsChapter8");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearPhysicsChapter9");
            startActivity(intent);
        }
    }
}
