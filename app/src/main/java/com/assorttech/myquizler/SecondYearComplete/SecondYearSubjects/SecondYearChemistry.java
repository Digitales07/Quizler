...
import com.assorttech.myquizler.SecondYearComplete.SecondYearChapters.SecondYearChemistryChapters;

public class SecondYearChemistry extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_second_year_chemistry);
    ...
    public void onClick(View position)
    {
        ...
        if (position == mChapterWise) {
            ...
            startActivity(new Intent(SecondYearChemistry.this, SecondYearChemistryChapters.class));

        } else if (position == mPastPaper) {

            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearChemistry.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearChemistryPastPaper");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearChemistry.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearChemistryFirstHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearChemistry.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearChemistrySecondHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(SecondYearChemistry.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "SecondYearChemistryFullBook");
            startActivity(intent);
        }
    }
}
