...
import com.assorttech.myquizler.TenthComplete.TenthChapters.TenthComputerChapters;

public class TenthComputer extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tenth_computer);
    ...
    public void onClick(View position)
    {
        if (position == mChapterWise) {
            ...
            startActivity(new Intent(TenthComputer.this, TenthComputerChapters.class));

        } else if (position == mPastPaper) {

            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthComputer.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthComputerPastPaper");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthComputer.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthComputerFirstHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthComputer.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthComputerSecondHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthComputer.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthComputerFullBook");
            startActivity(intent);
        }
    }
}
