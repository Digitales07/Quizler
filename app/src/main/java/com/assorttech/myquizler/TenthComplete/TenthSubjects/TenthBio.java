...
import com.assorttech.myquizler.TenthComplete.TenthChapters.TenthBioChapters;

public class TenthBio extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tenth_bio);
    ...
    public void onClick(View position)
    {
        if (position == mChapterWise) {
            ...
            startActivity(new Intent(TenthBio.this, TenthBioChapters.class));

        } else if (position == mPastPaper) {
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthBio.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthBioPastPaper");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthBio.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthBioFirstHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthBio.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthBioSecondHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthBio.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthBioFullBook");
            startActivity(intent);
        }
    }
}
