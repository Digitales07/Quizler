...
public class TenthComputerChapters extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tenth_computer_chapters);
    ...
    public void onClick(View position)
    {
        if (position == mOne) {
            ...
            Intent intent = new Intent(TenthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthComputerChapter1");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthComputerChapter2");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthComputerChapter3");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthComputerChapter4");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthComputerChapter5");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthComputerChapter6");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthComputerChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthComputerChapter7");
            startActivity(intent);
        }
