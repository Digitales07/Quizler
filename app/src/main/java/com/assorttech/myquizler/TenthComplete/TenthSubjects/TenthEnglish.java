...
import com.assorttech.myquizler.TenthComplete.TenthChapters.TenthEnglishChapters;

public class TenthEnglish extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tenth_english);
    ...
    public void onClick(View position)
    {
        if (position == mChapterWise) {
            ...
            startActivity(new Intent(TenthEnglish.this, TenthEnglishChapters.class));

        } else if (position == mPastPaper) {

            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglish.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishPastPaper");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglish.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishFirstHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglish.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishSecondHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglish.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishFullBook");
            startActivity(intent);
        }
    }
}
