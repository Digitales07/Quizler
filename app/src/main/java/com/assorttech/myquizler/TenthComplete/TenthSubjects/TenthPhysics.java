...
import com.assorttech.myquizler.TenthComplete.TenthChapters.TenthPhysicsChapters;

public class TenthPhysics extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tenth_physics);
    ...
    public void onClick(View position)
    {
        if (position == mChapterWise) {
            ...
            startActivity(new Intent(TenthPhysics.this, TenthPhysicsChapters.class));

        } else if (position == mPastPaper) {

            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthPhysics.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthPhysicsPastPaper");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthPhysics.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthPhysicsFirstHalf");
            startActivity(intent);
        } else if (position == mSecondHalf) {

            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthPhysics.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthPhysicsSecondHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthPhysics.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthPhysicsFullBook");
            startActivity(intent);
        }
    }
}
