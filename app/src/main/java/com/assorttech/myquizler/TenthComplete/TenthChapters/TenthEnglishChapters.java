...
public class TenthEnglishChapters extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tenth_english_chapters);
    ...
    public void onClick(View position)
    {
        if (position == mOne) {
            ...
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter1");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter2");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter3");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter4");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter5");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter6");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter7");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter8");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter9");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter10");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter11");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter12");
            startActivity(intent);
        }
        else if (position==mthirteen){
            mMySoundPool.ClickSound();
            Intent intent = new Intent(TenthEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "TenthEnglishChapter13");
            startActivity(intent);
        }
    }
}
