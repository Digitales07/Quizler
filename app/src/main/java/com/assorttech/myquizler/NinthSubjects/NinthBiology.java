...
import com.assorttech.myquizler.NinthQuizType.NinthBioQuizType.NinthBioChapterWise.NinthBioChapters;
import com.assorttech.myquizler.QuizScreenActivity;
import com.assorttech.myquizler.R;

public class NinthBiology extends Activity implements View.OnClickListener {
    ...
    public void onClick(View position)
    {
        if (position == mChapterWise) {
            ...
            startActivity(new Intent(NinthBiology.this, NinthBioChapters.class));

        } else if (position == mPastPaper) {

            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthBiology.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioPastPaper");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthBiology.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioFirstHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthBiology.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioSecondHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthBiology.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthBioFullBook");
            startActivity(intent);
        }
    }
}
