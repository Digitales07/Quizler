...
import com.assorttech.myquizler.NinthQuizType.NinthBioQuizType.NinthEnglishChapters;
import com.assorttech.myquizler.QuizScreenActivity;
import com.assorttech.myquizler.R;

public class NinthEnglish extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View position)
    {
        if (position == mChapterWise) {
            ...
            startActivity(new Intent(NinthEnglish.this, NinthEnglishChapters.class));

        } else if (position == mPastPaper) {
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthEnglish.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthEnglishPastPaper");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthEnglish.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthEnglishFirstHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthEnglish.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthEnglishSecondHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthEnglish.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthEnglishFullBook");
            startActivity(intent);
        }
    }
}
