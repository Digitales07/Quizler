package com.assorttech.myquizler.NinthPhysicsQuizType.NinthPysicsChapterWise;
...
public class NinthPhysicsChapters extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ninth_physics_chapters);
    ...
    public void onClick(View position)
    {
        if (position == mOne) {
            ...
            Intent intent = new Intent(NinthPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthPhysicsChapter1");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthPhysicsChapter2");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthPhysicsChapter3");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthPhysicsChapter4");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthPhysicsChapter5");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthPhysicsChapter6");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthPhysicsChapter7");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthPhysicsChapter8");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(NinthPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "NinthPhysicsChapter9");
            startActivity(intent);
        }
    }
}
