...
public class FirstYearPhysicsChapters extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_year_physics_chapters);
    ...
    public void onClick(View position)
    {
        if (position == mOne) {
            ...
            Intent intent = new Intent(FirstYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearPhysicsChapter1");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearPhysicsChapter2");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearPhysicsChapter3");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearPhysicsChapter4");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearPhysicsChapter5");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearPhysicsChapter6");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearPhysicsChapter7");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearPhysicsChapter8");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearPhysicsChapter9");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearPhysicsChapter10");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearPhysicsChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearPhysicsChapter11");
            startActivity(intent);
        }
    }
}
