...
public class FirstYearMathChapters extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_year_math_chapters);
    ...
    public void onClick(View position)
    {
        if (position == mOne) {
            ...
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter1");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter2");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter3");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter4");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter5");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter6");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter7");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter8");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter9");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter10");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter11");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter12");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearMathChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearMathChapter13");
            startActivity(intent);
        }
    }
}
