...
import com.assorttech.myquizler.FirstYearComplete.FirstYearChapters.FirstYearChemistryChapters;
...
public class FirstYearChemistry extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View position)
    {
        if (position == mChapterWise) {
            ...
            startActivity(new Intent(FirstYearChemistry.this, FirstYearChemistryChapters.class));

        } else if (position == mPastPaper) {

            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearChemistry.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearChemistryPastPaper");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearChemistry.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearChemistryFirstHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearChemistry.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearChemistrySecondHalf");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearChemistry.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearChemistryFullBook");
            startActivity(intent);
        }
    }
}
