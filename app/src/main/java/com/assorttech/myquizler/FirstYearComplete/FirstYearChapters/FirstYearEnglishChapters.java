...
public class FirstYearEnglishChapters extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_year_english_chapters);
        ...
        mFourteen=findViewById(R.id.first_eng_fourteen);
        mFifteen=findViewById(R.id.first_eng_fifteen);
    ...
    public void onClick(View position)
    {
        if (position == mOne) {
            ...
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter1");
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter2");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter3");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter4");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter5");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter6");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter7");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter8");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter9");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter10");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter11");
            startActivity(intent);
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter12");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter13");
            startActivity(intent);
        }
            ...
            mMySoundPool.ClickSound();
            Intent intent = new Intent(FirstYearEnglishChapters.this, QuizScreenActivity.class);
            intent.putExtra("Ref", "FirstYearEnglishChapter14");
            startActivity(intent);
        }
